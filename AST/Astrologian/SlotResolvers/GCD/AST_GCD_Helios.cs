...
public class AST_GCD_Helios : BaseSlotResolver
{
    public static AST_GCD_Helios Instance { get; } = new();
    public override uint SpellId => SpellsDefine.Helios;
    ...
    protected override int RunCheck()
    {
        ...
        if (SpellId.RecentlyUsed(2500)) return -9;
